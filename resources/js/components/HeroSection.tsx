...
const HeroSection: React.FC = () => {
    return (
        <section className="flex min-h-70vh items-center justify-center bg-yellow-100 px-6 py-16 md:px-20">
            <div className="flex w-full max-w-7xl flex-col items-center gap-10 md:flex-row">
                ...
                >
                    <h1 className="text-5xl leading-tight font-extrabold text-blue-900 md:text-6xl">
                        Elevate Your Look at <br />
                         <span className="text-yellow-400">UltraCare</span> Barbing Salon
                    </h1>
                    ...
                    <Link href="/about-contact" className="mt-6 inline-block rounded bg-blue-900 px-6 py-2 font-semibold text-white transition hover:bg-blue-800">
                       Book an Appointment
                    </Link>
                </motion.div>
                ...
                <motion.div className="flex-1" initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
                    <img
                        ...
                        alt="Barbing Hero"
                        className="h-170 w-250 rounded-xl object-cover shadow-lg"
                    />
                </motion.div>
            </div>
        </section>
