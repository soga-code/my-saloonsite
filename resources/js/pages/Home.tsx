            ...
            <div className="min-h-screen bg-yellow-50 text-blue-900">
                ...
                <section className="bg-yellow-400 px-6 py-20">
                    <div className="mx-auto max-w-full">
                        ...
                        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 md:grid-cols-3 mx-12">
                            <div className="rounded-xl p-6 shadow-md transition-transform duration-300 hover:scale-105 hover:shadow-xl text-center">
                                <h4 className="mb-2 text-xl font-bold text-white">💈 Experienced Barbers</h4>
                                <p className="text-white">Our skilled barbers bring years of experience and creativity to every cut.</p>
                            </div>
                            <div className="rounded-xl p-6 shadow-md transition-transform duration-300 hover:scale-105 hover:shadow-xl text-center">
                                <h4 className="mb-2 text-xl font-bold text-white">🧼 Clean & Comfortable</h4>
                                <p className="text-white">Enjoy a relaxing, sanitized environment designed for your comfort.</p>
                            </div>
                            <div className="rounded-xl p-6 shadow-md transition-transform duration-300 hover:scale-105 hover:shadow-xl text-center">
                                <h4 className="mb-2 text-xl font-bold text-white">💰 Affordable Prices</h4>
                                <p className="text-white">Look good without breaking the bank—premium grooming at fair rates.</p>
                            </div>
                        </div>
